...
require_once("languages/".$player -> lang."/quest4.php");

$objAction = $db -> Execute("SELECT `action` FROM `questaction` WHERE `player`=".$player -> id." AND `quest`=4");
$objQuest = new Quests('grid.php', 4, $objAction -> fields['action']);
...
if ($objAction -> fields['action'] == '4')
{
    ...
    $smarty -> assign("Text", "<br /><br /> Otrzymujesz ".$xx. " mithrillu.");
