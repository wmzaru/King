...
require_once("languages/".$player -> lang."/quest11.php");

$objAction = $db -> Execute("SELECT `action` FROM `questaction` WHERE `player`=".$player -> id." AND `quest`=11");
$objQuest = new Quests('grid.php', 11, $objAction -> fields['action']);
