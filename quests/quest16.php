...
require_once("languages/".$player -> lang."/quest16.php");

$objAction = $db -> Execute("SELECT `action` FROM `questaction` WHERE `player`=".$player -> id." AND `quest`=16");
$objQuest = new Quests('grid.php', 16, $objAction -> fields['action']);
