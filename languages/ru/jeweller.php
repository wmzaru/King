...
/**
 *   File functions:
 *   Russian language for jeweller workshop
 *
 *   @name                 : jeweller.php
...
//
// $Id: jeweller.php 819 2006-11-16 14:57:05Z thindil $
...
if (!isset($_GET['step']))
{
    define('JEWELLER_INFO', '<p>Opis sklepu jubilera... Chcesz coś zrobić?</p>');
    ...
    define('A_ASTRAL', 'Wykonuj astralną biżuterię');
}
    else
{
    define('A_BACK', 'Назад');
...
{
    define('HERE_IS', 'Tutaj możesz kupić plany różnych pierścieni.');
}
