...
/**
 *   File functions:
 *   Russian language for chop trees
 *
 *   @name                 : lumberjack.php                            
...
define('ERROR', 'Ошибка!');
define('YOU_DEAD', 'Nie możesz wyrąbywać drewna, ponieważ jesteś martwy! (<a href="las.php">Назад<a/>)');
define('NO_LICENSE', 'Nie masz licencji na wyrąb drewna w lesie! (<a href="las.php">Назад</a>)');
define('A_BACK', 'Назад');
