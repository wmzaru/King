...
if (!isset($_GET['action']))
{
    ...
    {
        define('HOUSE_INFO', 'Opis 1...'.$city1);
        define('HOUSE_INFO2', 'Opis 2...'.$city1);
    }
        else
    {
        define('HOUSE_INFO', 'Opis 1...'.$city2);
        define('HOUSE_INFO2', 'Opis 2...'.$city2);
	}
...
if (isset($_GET['action']) && $_GET['action'] == 'land')
{
    ...
    define('LAND_INFO', 'Opis sklepu z parcelami.');
...
if (isset($_GET['action']) && $_GET['action'] == 'my')
{
    ...
    if (isset($_GET['step']) && $_GET['step'] == 'locator')
    {
        ...
        define('O_ADD', 'Добавить');
        define('O_DELETE', 'Удалить');
