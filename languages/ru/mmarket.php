...
/**
 *   File functions:
 *   Russian language for potions market
 *
 *   @name                 : mmarket.php                            
...
//
// 
// $Id: mmarket.php 856 2006-11-29 17:30:36Z thindil $
...
if (isset ($_GET['view']) && $_GET['view'] == 'szukaj') 
{
    ...
    define('S_INFO2', 'Uwaga! Wpisz nazwę miktury którą poszukujesz.');
    define('A_SEARCH', 'Szukaj');
    define('POTION2', 'Mikstura z');
}
