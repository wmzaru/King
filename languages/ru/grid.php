...
//
// $Id: grid.php 536 2006-07-27 19:40:07Z thindil $
...
{
    define('NO_ENERGY', 'Nie masz wystarczająco energii aby zwiedzać kanały.');
    define('YOU_DEAD', 'Nie możesz zwiedzać kanałów ponieważ jesteś martwy!');
...
{
    define("LAB_INFO", "Opis kanałów $city1. Czy jesteś pewien, że chcesz podążać w nieznane?");
}
?>
