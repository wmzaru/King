...
define('C_NOGENDER', 'Nie masz jeszcze wybranej płci. <a href="card.php?action=gender">Назад</a>, aby to zrobić.');
define('C_NORACE', 'Nie masz jeszcze wybranej rasy. <a href="card.php?action=race">Назад</a>, aby to zrobić.');
