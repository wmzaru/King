...
/**
 *   File functions:
 *   Russian language for player stats
 *
 *   @name                 : stats.php
...
define('REPUT_TXT', 'Reputacja');
define('DYNALCA_ANTIDOTE', '<b>Anty dynallca</b>: ');
define('NUTARI_ANTIDOTE', '<b>Anty nutari</b>: ');
define('ILLANI_ANTIDOTE', '<b>Anty illani</b>: ');
define('TIME_RESURECT', '<b>Wskrzeszenie</b>: ');
