...
/**
 *   File functions:
 *   Russian language for exploring forest and moutains
 *
 *   @name                 : explore.php                            
...
{
    define('M_INFO', 'Dookoła siebie widzisz wysokie szczyty Gór Migotliwych. Czy chcesz zobaczyć co znajduje się wśród nich? Każde zwiedzanie kosztuje 0,5 energii.');
}
