...
/**
 *   File functions:
 *   Russian language for jewellers market
 *
 *   @name                 : rmarket.php                            
...
//
// $Id: rmarket.php 856 2006-11-29 17:30:36Z thindil $
...
if (!isset($_GET['view']) && !isset($_GET['buy']) && !isset($_GET['wyc']))
{
    ...
    define("M_INFO", "Tutaj jest rynek jubilerski. Masz parę opcji");
}

if (isset ($_GET['view']) && $_GET['view'] == 'szukaj') 
{
    define("S_INFO", "Szukaj ofert na rynku lub");
    define("S_INFO2", ". Uwaga! Wpisz dokładną nazwę przedmiotu jakiego poszukujesz.");
