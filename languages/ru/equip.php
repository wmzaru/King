...
/**
 *   File functions:
 *   Russian language for equipment
 *
 *   @name                 : equip.php
...
define('N_FOR', ' za ');
define('SELL_ALL_POTIONS', 'Sprzedaj wszystkie posiadane mikstury');
...
{
    define('YOU_SELL_ALL', 'Sprzedałeś wszystkie mikstury ');
}
...
if (isset($_GET['poison']))
{
    ...
    define('YOU_DESTROY', 'Kiedy polałeś trucizną ostrze, nagle zaczęło ono się topić. Przerażony próbowałeś usunąć miksturę z broni, lecz było już za późno. Twoja broń została kompletnie zniszczona.');
