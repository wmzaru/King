...
/**
 *   File functions:
 *   Russian language for minerals market
 *
 *   @name                 : pmarket.php                            
...
//
// $Id: pmarket.php 856 2006-11-29 17:30:36Z thindil $
...
if (isset ($_GET['view']) && $_GET['view'] == 'szukaj') 
{
    ...
    define('S_INFO2', 'Jeżeli nie znasz dokładnej nazwy minerału, użyj znaku * zamiast liter');
